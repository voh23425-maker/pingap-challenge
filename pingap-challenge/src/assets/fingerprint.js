...
(function (global, factory) {
    var PingapJsChallenge = {};
    global.PingapChallenge = function (nonce) {
        return PingapJsChallenge.load().then(function (fp) {
            return fp.get({ extendedResult: true });
        }).then(function (result) {
            var data = JSON.stringify(result);
            return CryptoJS.AES.encrypt(data, nonce).toString();
        });
    };
    // console.dir(global);
    factory(PingapJsChallenge)
