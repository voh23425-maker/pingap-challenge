export default {
  ...
  plugin: {
    ...
    challengeUrl: "链接",
    challengeUrlPlaceholder: "输入challenge的链接",
    challengeCookieName: "Cookie名称",
    challengeCookiePlaceholder: "输入challenge的cookie名称",
    challengeSecret: "密钥",
    challengeSecretPlaceholder: "输入challenge的密钥",
    challengeTtl: "有效期",
